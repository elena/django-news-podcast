...
Following the very high standard set by DjangoCon EU in Poland last year, it is being held on its own island "L'île des Embiez", located on the Côte d'Azur, between Toulon and Marseille. (no tickets announced yet, should be this week). The island is only accessible be a short boat trip and will be used exclusively by DjangoCon EU.
